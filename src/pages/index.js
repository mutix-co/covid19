...
export default function index() {
  ...
  return (
    <form onSubmit={onSubmit}>
      ...
      <Note>使用準則</Note>
      <Note>1. 本服務為 AGPL 3.0 開源專案，由 mutix Co., Ltd.（以下簡稱本機構）維運，並免費提供使用</Note>
      <Note>2. 本機構不會對使用者、商家、非營利組織、政府及任何個人與組織收取任何費用</Note>
      <Note>
      ...
      <Note>2. 加密資料將交由 mutix Co., Ltd.（以下簡稱本機構）暫時保管，並儲存於 Google 位於台灣的機房</Note>
      <Note>3. 我已知悉個資保護是基於 x25519-xsalsa20-poly1305 加解密技術實作</Note>
      <Note>4. 我已知悉個資將於 28 日後自動完全情除</Note>
      <Note>5. 我已知悉如遺失金鑰，本機構無法提供任何技術將其資料解密</Note>
      <Note>6. 我已知悉本機構無法擔保登錄者資料之真實性</Note>
      <Note>7. 除收到中華民國政府公文或司法文件外，本機構不提供任何資料的查閱或修改</Note>
      <Note>8. 除重大災害或不可抗力之因素外，本機構確保 99.8% 的時間正常服務，但本機構不負任何損害賠償責任</Note>
