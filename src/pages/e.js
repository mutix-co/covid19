...
export default function Event() {
  ...
  return (
    <form onSubmit={onSubmit}>
      ...
      <Input title="聯絡電話 (Contact Number)" onChange={onContactNumberChange} value={contactNumber} />
      <Input title="電子郵件 (E-mail)" onChange={onEmailChange} value={email} />
      ...
      <Note>4. 除收到中華民國政府公文或司法文件外，本公司不提供任何資料的查閱或修改</Note>
